...
const NavigationSidebar = ( {
    ...
    return(
            ...
            <Link to= "/a6/twitter/explore" className={`list-group-item list-group-item-action py-3 wd-clr-black ${active === 'Explore' ? 'active':''} align-content-center`} href="../ExploreScreen/explore.html">
                <div className="row">
                    <div className="col-xxl-2 col-xl-2 col-lg-1 col-md-2 col-sm-1">
